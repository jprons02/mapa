...
class Upload extends React.Component {
  ...
  renderUpload = () => {
    const successOrErrorUpload = this.state.fileUploaded
      ? "success"
      : this.state.showInvalidErrorUpload
      ? "error"
      : "";
    ...
    return (
      <React.Fragment>
        ...
        <Form className={successOrErrorUpload} style={{ marginTop: "30px" }}>
              ...
              content={
                ...
                this.props.selectedFile === null
                  ...
                  : this.state.isUploading &&
                    this.props.selectedFile.name === false
                  ? "Choose File"
          ...
          />
          <Message error header="Please select a file" />
      ...
      <React.Fragment>
        ...
        <Segment style={{ padding: "20px 14px 40px 14px" }} raised>
          <div style={{ paddingBottom: "20px" }}>
            ...
            <List bulleted>
              <List.Item>
                To categorize as spanish please prefix file name with "sp_".
                <br />
                Example: "sp_village.mov"
              </List.Item>
              <List.Item>
                To categorize as logo, please use the word "logo" somewhere in
